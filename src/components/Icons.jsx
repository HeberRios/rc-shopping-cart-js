...
export function ClearCartIcon() {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className='icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart-off'
    >
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
      <path d='M6 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0' />
...
export function RemoveProductFromCartIcon() {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
...
export function AddUnitToCartIcon() {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
